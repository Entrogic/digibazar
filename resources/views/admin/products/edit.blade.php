...
@section('content')
        ...
        <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
            <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description_en" id="description_en" rows="4"
                                ...
                                placeholder="English description (optional)">{{ old('description_en', $product->description_en) }}</textarea>
                ...
                @if (!empty($product->images))
                    <div class="border-b border-gray-900/10 pb-6">
                        <h2 class="text-lg font-semibold leading-7 text-gray-900">Current Images</h2>
                        <p class="mt-1 text-sm leading-6 text-gray-600">Existing product images</p>
                ...
                <!-- New Images -->
                <div class="border-b border-gray-900/10 pb-6">
                    <h2 class="text-lg font-semibold leading-7 text-gray-900">Replace Images</h2>
                    <p class="mt-1 text-sm leading-6 text-gray-600">Upload new product images (will replace existing
                        images)</p>
    ...
    <script>
        ...
        document.getElementById('images').addEventListener('change', function(e) {
            ...
            if (files.length > 0) {
                console.log(`Selected ${files.length} image(s) for replacement`);
