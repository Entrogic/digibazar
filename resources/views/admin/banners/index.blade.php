    ...
    <div class="p-6">
        ...
        <div class="sm:flex sm:items-center sm:justify-between mb-8">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">View and manage all banners</p>
            </div>
            ...
            <div class="px-4 py-5 sm:p-6">
                                ...
                                @foreach ($banners as $category)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            ...
                                            @else
                                                <span class="text-gray-400">No Parent</span>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <a href="{{ route('admin.banners.edit', $category) }}" class="text-indigo-600 hover:text-indigo-900">
                                                ...
                                                <form action="{{ route('admin.banners.destroy', $category) }}" method="POST" class="inline delete-form" data-id="{{ $category->id }}">
                                                @csrf
                                                @method('DELETE')
                ...
                @else
                    ...
                    <div class="text-center py-12">
                        ...
                        <h3 class="mt-4 text-sm font-medium text-gray-900">No banners found</h3>
    ...
    document.querySelectorAll('.delete-btn').forEach(button => {
        button.addEventListener('click', async function (e) {
            ...
            try {
                ...
                if (response.ok) {
                    // সফল হলে row টা টেবিল থেকে সরানো হবে
