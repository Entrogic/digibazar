...
@section('content')
    <div class="p-6">
        ...
        <div class="mb-8">
            ...
            <p class="mt-1 text-sm text-gray-600">View the overall status of your system</p>
        </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <dd class="text-2xl font-bold text-gray-900">{{ $pendingOrders }}</dd>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-lg">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <dt class="text-sm font-medium text-gray-500">Today's Orders</dt>
                            <dd class="text-2xl font-bold text-gray-900">{{ $todayOrders }}</dd>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <a href="{{ route('admin.orders.index') }}"
                        class="bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg p-4 text-center transition duration-200 block">
