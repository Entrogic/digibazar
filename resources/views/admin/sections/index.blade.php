            ...
            <div id="sections-list" class="divide-y divide-gray-200">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-3 mt-1">
                                        <span class="text-sm text-gray-500">Type: <span
                                                class="font-medium">{{ str_replace('_', ' ', $section->type) }}</span></span>
                                        <span class="text-sm text-gray-400">•</span>
                                        <span
                                            class="text-sm {{ $section->is_active ? 'text-green-600' : 'text-red-600' }}">
                ...
                @empty
                    <div class="p-12 text-center">
                        <p class="text-gray-500 text-lg">No sections created yet. Click "Add New Section" to get
                            started!</p>
                    </div>
                @endforelse
            </div>
